...
public class StudentMain {
	...
	public void studentClientPage(Student student) {
		...
		while (true) {
			...
			if (student.getRegistrationStatus() == true && student.getAdminStatus() == false) {
				System.out.println("Registration already completed waiting Admin Approval");
				continue;
			}
			...
			case 1:
				courseOperation.displayCoursesStudent(student);
				continue;
			...
			case 2:
				if (student.getRegistrationStatus() == false) {
					...
					System.out.println("Registration already completed. Admin need to Approved");
				}
				continue;
			...
			// display all the courses that student has selected so far with Registration
			// status
			case 4:
			...
			// submit registration
			case 5:
				if (!student.getAdminStatus()) {
					System.out.println("Admin need to approval");
					...
					// if number of courses selected by students is <4 or >4
						...
						case 1:
							...
							System.out.println("Total payable fees: Rs " + payableAmount); // total payable amount after
																							// deduction of scholarship
																							// allowance
							System.out.println("*********************************************************************");
							...
							case 1:
								...
								case 1:
									System.out.println("Registration succesfully completed on " + currentDate
											+ " using DEBIT_CARD");
									break;
								// fees submission using e-wallet
								case 2:
									System.out.println(
											"Registration succesfully completed on " + currentDate + " using E_WALLET");
									break;
								...
								registrationOperation.generateRegistrationReciept(student, payableAmount,
										paymentOption);
